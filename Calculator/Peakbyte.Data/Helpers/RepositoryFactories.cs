...
{
    /// <summary>
    /// A maker of Peakbyte Repositories.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Return the runtime Peakbyte repository factory functions,
        /// each one is a factory for a repository of a particular type.
        /// </summary>
        /// <remarks>
        /// MODIFY THIS METHOD TO ADD CUSTOM Peakbyte FACTORY FUNCTIONS
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetPeakbyteFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                   {typeof(ICalculationRepository), dbContext => new CalculationRepository(dbContext)}
                };
        }

        /// <summary>
        /// Constructor that initializes with runtime Peakbyte repository factories
        /// </summary>
        public RepositoryFactories()  
        {
            _repositoryFactories = GetPeakbyteFactories();
        }
